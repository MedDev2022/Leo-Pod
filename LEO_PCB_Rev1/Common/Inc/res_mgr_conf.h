...
/* core2 -> CPU2, CortexM4 for STM32H7 */
  ...
  RES_DEFAULT_ASSIGN_CPU2,  /* RESMGR_ID_UART4 */
  RES_DEFAULT_ASSIGN_CPU2,  /* RESMGR_ID_UART7 */
  RES_DEFAULT_ASSIGN_CPU2,  /* RESMGR_ID_UART8 */
  RES_DEFAULT_ASSIGN_CPU2,  /* RESMGR_ID_USART1 */
  RES_DEFAULT_ASSIGN_CPU2,  /* RESMGR_ID_USART2 */
  RES_DEFAULT_ASSIGN_CPU2,  /* RESMGR_ID_USART3 */
  RES_DEFAULT_ASSIGN_CPU1,  /* RESMGR_ID_USART6 */
